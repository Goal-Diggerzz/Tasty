                ...
                <div className='divf'>
                  <Col>
                    ...
                    {this.state.newFavSasasasasasasasa.map((data ,index) =>
                      <>
                        <Card className='card2' key={index}  onClick={this.viewFavorite} >
                          <Card.Body bsPrefix required='card-body' >
                            <Card.Img className='card-img-top2' variant="top" src={data.img} alt="First slide" />
                            <Card.Title className='card2-title'>{data.label}</Card.Title>
                            <Card.Text >
                  ...
                  <Col>
                    ...
                    {this.state.newFavSasasasasasasasa.map((data,index) =>
                      <>
                        ...
                        <Card className='card2' key={index} >
